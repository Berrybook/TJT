...
public interface ReportDAO extends JpaRepository<Invoice, Long> {
	...
	@Query("select pi.pos_table,pi.tyrepattern,pi.tyresize,pi.quantity from POS_Item pi")
