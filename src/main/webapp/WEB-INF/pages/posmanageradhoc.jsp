...
<body>
<form action="salesmanByCitypos" method="get">
                              ...
                              <font size="5px" color="white">
                               Adhoc SalesMan
                            	...
                            	<br>
                                        ...
                                        <div class="col-md-4">
                       <div class="form-group">
                    <input type="Submit" value="Search" name="Search" style="position:absolute;top:40%;">
...
<td>${listadhoc.pos}</td>
<td><a href="salesmanByIdpos?id=${listadhoc.userid}"><input type="button" value="Assign" class="btn btn-danger"></a></td>
</tr>
</c:forEach>
