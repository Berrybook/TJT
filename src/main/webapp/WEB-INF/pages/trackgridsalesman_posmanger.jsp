	...
	<div id="RoleRegistration">
		...
		<nav class="cd-side-nav">
				...
				<br>
					...
					<li><a href="datewisereportPosmgr" style=" text-decoration: none;">Summary Tracker</a></li></ul>
		...
		<form action="viewreportPosmanager" method="get" name="track" id="track"  onSubmit="return validateForm()">
