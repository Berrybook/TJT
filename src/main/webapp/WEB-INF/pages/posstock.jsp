                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control">
                                             <div title="" class="multiselect dropdown-toggle " data-toggle="dropdown">
                                                <span class="multiselect-selected-text"class="form-control" >Select  Tyres</span>
											</div>
                      							  ...
                      							  <div class="tyre-type">
                                            		 <%! int data=1;  %>
                           						 	<input class="form-check-input check-tyre-type" type="checkbox" name="tyre" id= <%= data %>  value="${tyreid.tyrepattern}/${tyreid.tyresize}"> ${tyreid.tyrepattern}/${tyreid.tyresize}
                       								 </div>
                       								 </div>
                   									 <div class="form-group col col-xs-4 tyre-quantity <%= data++ %> " >
