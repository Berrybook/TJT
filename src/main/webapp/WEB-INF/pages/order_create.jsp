...
<div id="content">
	...
	<main class="cd-main-content">
		...
		<nav class="cd-side-nav">
            ...
            <br>
            <br>
<form action="createOrder" method="post" name="ordercreate" id="ordercreate">
                            ...
                            <div class="row">
							 ...
							 <div class="col-md-3">
                                            <div class="form-group">
                   				       	  ...
                   				       	  <select class="form-control" class="form-control chosen-select"  name="raisedby"  id="raisedby" >
                                    ...
                                    <input type="date" class="form-control"  data-date-format="YYYY MM DD"  placeholder="Enter Date" id="requisition_Date" name="requisition_Date" value="">
                                            </div>
										</div>
										</div>
										<div class="row">
...
$(function() {
  ...
  $("form[name='ordercreate']").validate({
    ...
    messages: {
      raisedby: "Please enter raisedby",
	   requisition_Date: "Please enter  requisition_Date",
	     expected_Date: "Please enter  expected_Date",
		 orderpriority: "Please enter orderpriority",
		  pattern: "Please enter pattern",
		   dealer_id: "Please enter dealer_id",
