...
<select class="form-control" name="adhocPos"  id="adhocPos">
								  ...
								  <input placeholder="Date" class="form-control" type="text" onfocus="(this.type='date')" name="startDate" id="date"> 
                                            </div>
                                        </div>
                                  ...
                                  <!--   <input type="date" class="form-control"  data-date-format="YYYY MM DD"  placeholder="Enter End Date" id="endDate" name="endDate" required> -->
								    <input placeholder="Date" class="form-control" type="text" onfocus="(this.type='date')" name="endDate" id="date1"> 
                                            </div>
                                        </div>
...
<c:forEach var="listdto" items="${listdto}">
	 ...
	 <td>${listdto.endDate}</td>
			...
			<div class="col-md-3"></div>
				...
				<input  type="submit" id="asign" v-on:click="Save" class="btn btn-danger submit-button" value="Assign">
				</div>
                <div class="col-md-1">
