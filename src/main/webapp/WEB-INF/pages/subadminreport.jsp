	...
	<main class="cd-main-content">
		...
		<br><br>
		   ...
		   <a  style="font-size: 36px;" data-toggle="tooltip"
               ...
               <form action="subadminlistofsalebydate" method="post" name="salereportform" onsubmit="return salereport()">
                			     ...
                			     <div class="form-group">
                		          <b><label for="posid">POS</label></b>
                                    ...
                                    <b><label for="date"></label></b>
                                        <a href="subadminSalereport" type="button"  class="btn btn-danger">back</a>
