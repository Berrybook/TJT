...
<div >
   <button type="submit" style="height:9.5%;" class="btn" ><h3>Customer Inquiry Form</h3></button>
   <div>
   &nbsp;
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" placeholder="Customer PhoneNumber" name="phoneNumber" id="phoneNumber"  maxlength="10" onkeypress="return isNumber(event)" value="${user_update.mobilenumber }" required>
 ...
 <div class="input-con">
  ...
  <button type="submit" class="btn" value="save">submit</button>
</form>
