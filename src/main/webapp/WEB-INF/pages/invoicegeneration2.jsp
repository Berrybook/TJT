  ...
  <div class="card">
   ...
   <div class="cardpanel">
			...
			<div class="col-md-4">
                                ...
                                <div class="col-md-4">
								<div class="form-group">
                                    <b><label for="SpotDiscount">Spot Discount</label></b>
                                    <input type="number" class="form-control"  id="SpotDiscount" name="SpotDiscount" value="0">
                                
								</div>
								
								<!-- </div>
								<div class="col-md-1">
						 		<button  class="disable btn btn-danger" id="offer"  style="position:absolute;top:35%;" value="">Apply</button>
								</div> -->
                                
                                </div>
								<div class="col-md-1">
						 		<input type ="button"  class=" btn btn-danger" id="offer"  style="position:absolute;top:35%;" value="Apply" onclick="total()"/>
								</div>
                   <div class="col-md-3">
                        <div class="form-group">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                    <div class="col-md-12">
                    <b><label id="cupon" for="coupon">Coupon code</label></b>
                    </div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="col-md-2" id="firstchk">
                                        <div class="form-group">
                                         <input name="product" value="50" type="checkbox" class="custom-control" id="c1" onclick="total()"><p id="para">Like Our Page in Facebook</p> <br>
											
                                        </div>
                                    </div>
                                    <div class="col-md-2" id="secondchk">
                                        <div class="form-group">
                                          <input name="product" value="50" type="checkbox" class="custom-control" id="c2" onclick="total()"><p id="paraa">Posted in Facebook</p><br>  
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                     <input name="product" value="50" type="checkbox" class="custom-control" id="c3" onclick="total()"><p id="three">Posted in Twitter</p><br>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input name="product" value="50" type="checkbox" class="custom-control" id="c4" onclick="total()"><p id="four"> Posted in Instagram</p><br>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input name="product" value="50" type="checkbox" class="custom-control" id="c5" onclick="total()"><p id="five"> Google Review</p><br>
                                        </div>
                                    </div>
                    ...
                    <div class="row">    
                         <div class="col-md-3">
                        <div class="form-group">
                            <b><label id="pr" for="totalprice">TotalPrice</label></b>
                   ...
                   <div class="col-md-3">
                   <div class="form-group">
                            <b><label id="dis" for="discountamount">Discount</label></b>
					...
					<div class="col-md-3">
                        <div class="form-group">
                            <div class="form-group">
                                <b><label id="pay" for="paymentmode">Payment</label></b>
...
function  checkinvoice(){ 
  ...
  function total() {
	  ...
	  var offerDiscount = document.getElementById("SpotDiscount").value;
	  debugger;
	  
	  if(quantity==2){
	  var taxble_amount= document.getElementById('beforgst').value -
	  ((input.length * (input.length =50*2))/1.28);
	  	document.getElementById('totalprice').value=total_gst(taxble_amount)- parseInt(offerDiscount);
