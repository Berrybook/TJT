...
<body>
	...
	<main class="cd-main-content">
		...
		<div class="content-wrapper">
            ...
            <br><br>
 <form action="invoicegeneration" method="post" name="invoice" onsubmit=" return checkinvoice()">
      <br><br>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                           <b><label for="phoneno">Contact No</label></b>
                             <input type="text" class="form-control" id="contactNumber" placeholder="Enter ContactNumber" name="contactNumber" maxlength="10" onkeypress="return isNumber(event)">                		
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded-0" id="address1" rows="2" name="address1" ></textarea>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <b><label for="Address">Address 2</label></b>
                            <textarea class="form-control rounded-0" id="address2" rows="2" name="address2" ></textarea>
                        </div>
                    </div>
                     <div class="col-md-3">
                     	<div class="form-group">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                           <b><label for="zipcode">Zip Code</label></b>
                            <input type="text" class="form-control" id="zipcode" placeholder="Enter zipcode " name="zipcode" value="${zipcode}" maxlength="6" onkeypress="return isNumber(event)">
                        </div>
                    </div>
             </div>
      	  </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
							...
							<input type="text" class="form-control" id="vehiclemake" placeholder="Enter Vehicle Make" name="vehiclemake" value="${vehiclemake }">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <b><label for="vehiclemodel">Vehicle Model</label></b>
                            <input type="text" class="form-control" id="vehiclemodel" placeholder=" Enter Vehicle Model" name="vehiclemodel" value="${vehiclemodel }">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <b><label for="vehiclenumber">Vehicle Number</label></b>
                       		<input type="text" class="form-control" id="vehiclenumber" placeholder="  Enter VehicleNumber" name="vehiclenumber" value="${vehiclenumber }">
                        </div>
                    </div>
            </div>
            <div class="row">
  					<div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="vehiclekm" placeholder=" Enter Vehicle KM run" name="vehiclekm" value="${vehiclekm }">
                        </div>
                    </div>
                    <div class="col-md-4">
                   		  <div class="form-group">
  		 ...
  		 <div class="cardpanel">
                <div class="row">
                   <div class="col-md-4">
                        <div class="form-group">
                            <div class="form-group">
                                <b><label for="tyretype">Tyre Pattern</label></b>
                     ...
                     <div class="col-md-4">
                          <div class="form-group" id="tyre">
                                <div class="form-group">
                                      <b><label for="tyresize">Tyre Size</label></b>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="tyreprice" name="tyreprice" placeholder=" Enter Price" onChange="return calculation()" >
                        </div>
                   </div>
                   </div>
                </div>
            ...
            <div class="row">
				<div class="col-md-4">
                       <div class="form-group">
                             ...
                             <input type="date" class="form-control"  data-date-format="YYYY MM DD"  placeholder="Enter Date" id="saledate" name="saledate" value="${saledate }">
                       </div>
                 </div>
                   <div class="col-md-3">
                        <div class="form-group">
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="aftergst" name="totalgst" readonly >
                            </div>
                        </div>
                    </div> 
                    </div>
                         ...
                         <div class="col-md-3">
                        	<div class="form-group">
                            	<b><label for="totalprice">Total Price</label></b>
                           			 <input type="text" class="form-control" id="totalprice" placeholder=" Your total Price" readonly name="totalprice"  value="${totalprice }">
                        	</div>
                    	</div>
                 		  <div class="col-md-3">
                   			<div class="form-group">
                            	<b><label for="discountamount">Discount Amount</label></b>
                         	  		 <input type="text" class="form-control" id="discountshow" name="discount" placeholder="Discount Amount" readonly >
                        	</div>
                   		 </div>
						<div class="col-md-3">
                       		<div class="form-group">
